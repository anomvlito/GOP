...
\begin{titlepage}
  \centering
  \vspace*{2cm}
  {\Huge\bfseries\color{gopcyan} Estudio \texttt{I2}\par}
  \vspace{0.4cm}
...
% ════════════════════════════════════════════════════════════════════════════
\input{secciones/01_analisis_temario}
\newpage
\input{secciones/02_planificacion_agregada}
\newpage
\input{secciones/03_mrp}
\newpage
\input{secciones/04_proyectos}
\newpage
\input{secciones/05_variabilidad}
\newpage
\input{secciones/06_bodegas}
\newpage
\input{secciones/07_anexo}
\newpage
\input{secciones/08_la_meta}
\newpage
\input{secciones/09_casos_cerveza}
\newpage
\input{secciones/10_formulario}
\newpage
\input{secciones/11_resumen_final}
